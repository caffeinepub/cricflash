...
function getArticleImage(id: string): string {
  let hash = 0;
...
export default function ArticleDetailPage() {
  ...
  return (
    <div className="max-w-[800px] mx-auto px-4 py-8">
      ...
      <h1 className="text-2xl md:text-3xl font-extrabold text-foreground leading-snug mb-6">
        {article.title}
      </h1>
      ...
      <div className="mt-10 pt-6 border-t border-border">
        <h3 className="font-bold text-foreground mb-4">Related Sections</h3>
