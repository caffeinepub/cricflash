import { j as jsxRuntimeExports, L as Link } from "./index-DSMNH8Gm.js";
...
function StatusBadge({
  ...
  if (status === "upcoming") {
    if (startingSoon) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 bg-amber-500/15 text-amber-600 dark:text-amber-400 text-xs font-bold px-2 py-0.5 rounded-full", children: [
...
function CardContent({ match }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 shadow-card hover:border-cric-border transition-colors", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status, startingSoon })
    ] }),
    matchNumber && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5 mb-2", children: matchNumber }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs text-muted-foreground", children: [
      matchDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        ...
        status === "upcoming" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1", children: formatMatchTime(matchDate) })
      ] }),
