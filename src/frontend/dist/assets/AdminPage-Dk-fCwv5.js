...
function LoginForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[400px] mx-auto px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8", children: [
