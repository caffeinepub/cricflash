import { d as createLucideIcon, r as reactExports, s as createDialogScope, j as jsxRuntimeExports, t as Root$3, v as Trigger$1, i as useComposedRefs, W as WarningProvider, h as createContextScope, w as Content$1, n as composeEventHandlers, x as createSlottable, y as Title, D as Description, z as Close, E as Portal$1, O as Overlay, c as cn, F as buttonVariants, S as Slot$1, G as cva, X, P as Primitive, H as reactDomExports, I as useLayoutEffect2, p as useCallbackRef, o as useControllableState, m as useId, J as Portal$2, K as hideOthers, M as useFocusGuards, N as ReactRemoveScroll, k as createSlot, Q as FocusScope, U as DismissableLayer, C as ChevronDown, V as useInternetIdentity, Y as useQueryClient, _ as useQuery, $ as createActorWithConfig, a0 as useSimpleAuth, u as useArticles, a1 as useCreateArticle, a2 as useUpdateArticle, a3 as useDeleteArticle, a4 as getClassifiedMatches, Z as Zap, a5 as Globe, B as Button, a6 as ue } from "./index-CWQEZRIt.js";
import { u as useDirection, c as createCollection } from "./index-Boaea9mt.js";
import { R as RefreshCw } from "./refresh-cw-Cm0M_GZ8.js";
import { C as Clock } from "./clock-Bd1J-NKW.js";
import { C as CircleAlert } from "./circle-alert-D7rz1Itk.js";
/**
...
function matchSlug(team1, team2, suffix) {
  const t1 = team1.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "");
  const t2 = team2.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "");
  return `${t1}-vs-${t2}-${suffix}-${(/* @__PURE__ */ new Date()).getFullYear()}`;
}
...
function getArticleCategory(series) {
...
function getArticleImage(series) {
  const s = series.toLowerCase();
...
function buildArticlePayload(match, type) {
  ...
  if (type === "dream11") {
    ...
    const isBattingFriendly = pitchDesc.toLowerCase().includes("batting") || pitchDesc.toLowerCase().includes("flat") || pitchDesc.toLowerCase().includes("paradise");
    ...
    content = [
      ...
      "",
      "## Batting vs Bowling",
      isBattingFriendly ? "Batting-friendly venue. Teams should aim for 160+ if batting first. Par score: 165-180." : "Decent contest between bat and ball. A score of 150-160 should be competitive.",
      "",
      "## Toss Impact",
      hasDew ? "Evening matches here are heavily impacted by dew. Chasing teams have a strong advantage once dew sets in." : "The toss is important but not decisive. Both sides have won batting and chasing at this venue.",
      "",
      "## Fantasy Tip",
      isSpinFriendly ? "Pick 2-3 spinners in your Dream11 team. The pitch will assist them significantly." : "Back your pacers for the powerplay and switch to batters for the final fantasy push."
    ].join("\n");
  } else {
  ...
  const excerpt = content.replace(/##[^\n]*/g, "").split("\n").filter((l) => l.trim().length > 20).slice(0, 2).join(" ").slice(0, 200);
  return {
    title,
    slug,
    content,
...
function LoginForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-sm mx-auto px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { className: "w-10 h-10 text-cric-red mx-auto mb-3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: "Admin Login" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Sign in to access the CricFlash admin panel" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      ...
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive font-medium", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          type: "submit",
...
const CATEGORIES = ["IPL", "PSL", "International", "General", "News"];
function ArticlePreview({
  ...
  const previewText = excerpt.trim() || content.slice(0, 400) + (content.length > 400 ? "..." : "");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground leading-snug", children: title || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground italic", children: "No title yet" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground whitespace-pre-wrap", children: previewText || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "No content yet" }) })
  ] });
}
function AdminPage() {
  const { isAdmin } = useSimpleAuth();
  const { actor, isFetching: actorFetching } = useActor();
  const waitForActor = reactExports.useCallback(async () => {
  ...
  const [fetchedMatches, setFetchedMatches] = reactExports.useState(
    () => {
      try {
  ...
  const [isFetchingMatches, setIsFetchingMatches] = reactExports.useState(false);
  const [isGenerating, setIsGenerating] = reactExports.useState(false);
  const [isPublishing, setIsPublishing] = reactExports.useState(false);
  const [automationLog, setAutomationLog] = reactExports.useState([]);
  const [matchListOpen, setMatchListOpen] = reactExports.useState(false);
  const [schedulerEnabled, setSchedulerEnabled] = reactExports.useState(() => {
    return localStorage.getItem("cricflash_scheduler_enabled") === "true";
  });
  const [lastRunTime, setLastRunTime] = reactExports.useState(
    () => localStorage.getItem("cricflash_last_run") || ""
  );
  const [lastRunArticlesCount, setLastRunArticlesCount] = reactExports.useState(
    () => Number(localStorage.getItem("cricflash_last_run_count") || "0")
  );
  const [lastRunStatus, setLastRunStatus] = reactExports.useState(
    () => localStorage.getItem("cricflash_last_run_status") || ""
  );
  const [isRunningAutomation, setIsRunningAutomation] = reactExports.useState(false);
  const schedulerRef = reactExports.useRef(null);
  const lastTriggeredDateRef = reactExports.useRef("");
  const [tgSettings, setTgSettings] = reactExports.useState(
    () => loadTelegramSettings()
  );
  const [isTesting, setIsTesting] = reactExports.useState(false);
  const handleSaveTelegram = () => {
    saveTelegramSettings(tgSettings);
    ue.success("Telegram settings saved!");
  };
  ...
  const handleTestTelegram = async () => {
    ...
    try {
      ...
      console.log("Telegram response:", result);
      if (result === "ok" || result.startsWith("ok")) {
        ue.success("Test message sent! Check your Telegram channel.");
      } else {
        throw new Error(result);
      }
    } catch (err) {
      const msg = err instanceof Error ? err.message : String(err);
      ue.error(`Test failed: ${msg}`);
      console.error("[Telegram Test]", err);
    } finally {
      setIsTesting(false);
    }
  };
  const addLog = (msg) => setAutomationLog((prev) => [
  ...
  const handleFetchMatches = async () => {
    ...
    try {
      ...
      ue.success(`Fetched ${deduped.length} matches successfully!`);
    } catch (err) {
      const msg = err instanceof Error ? err.message : String(err);
      addLog(`Fetch failed: ${msg}`);
      ue.error(`Failed to fetch matches: ${msg}`);
    } finally {
  ...
  const handleGenerateArticles = async () => {
    if (fetchedMatches.length === 0) {
      ue.error("No matches fetched. Click Fetch Matches first.");
      return;
    }
    ...
    try {
      ...
      ue.error(`Article generation failed: ${msg}`);
    } finally {
  ...
  const handlePublishAll = async () => {
    ...
    if (drafts.length === 0) {
      ue.info("No draft articles to publish.");
      return;
    }
    ...
    try {
      ...
      ue.success(`Published ${published} articles!`);
      await refetchArticles();
    } catch (err) {
      const msg = err instanceof Error ? err.message : String(err);
      addLog(`Publish error: ${msg}`);
      ue.error(`Failed to publish: ${msg}`);
    } finally {
  ...
  const [formCategory, setFormCategory] = reactExports.useState("General");
  const [formImageUrl, setFormImageUrl] = reactExports.useState("");
  const [formSlug, setFormSlug] = reactExports.useState("");
  const [formPublished, setFormPublished] = reactExports.useState(true);
  const [formFeatured, setFormFeatured] = reactExports.useState(false);
  const [formExcerpt, setFormExcerpt] = reactExports.useState("");
  ...
  const runDailyAutomation = reactExports.useCallback(async () => {
    ...
    try {
      ...
      addLog(`Published ${publishedCount2} articles`);
      if (publishedCount2 > 0) {
        addLog("Sending to Telegram...");
        const fresh = await refetchArticles();
        const justPublished = (fresh.data ?? []).filter((a) => a.status === "published").slice(0, publishedCount2);
        let tgSent = 0;
  ...
  const runDailyAutomationRef = reactExports.useRef(runDailyAutomation);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    schedulerRef.current = setInterval(check, 6e4);
    return () => {
  ...
  const handleSchedulerToggle = (enabled) => {
    ...
    ue.success(
      enabled ? "Auto Scheduler enabled (runs at 07:00 daily)" : "Auto Scheduler disabled"
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        ...
        if (formPublished) {
          sendViaTelegram({
            ...
            console.warn("[Telegram] Failed to send article:", err);
            ue.warning("Article published but Telegram send failed.");
          });
        }
      }
      resetForm();
      ...
      const msg = err instanceof Error ? err.message : String(err);
      ue.error(msg || "Failed to save article");
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      const msg = err instanceof Error ? err.message : String(err);
      ue.error(msg || "Failed to delete article");
    }
  };
  const isSaving = createArticleMutation.isPending || updateArticleMutation.isPending;
  const anyAutomationRunning = isFetchingMatches || isGenerating || isPublishing || isRunningAutomation;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-5xl mx-auto px-3 py-6 overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-extrabold text-foreground", children: "Admin Panel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Manage CricFlash articles and content" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5 text-cric-red" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Content Automation" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: "Fetch live matches from CricAPI, auto-generate articles, and publish in one click." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-extrabold text-foreground", children: fetchedMatches.length }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-0.5 flex items-center justify-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-3 h-3" }),
                "Matches Fetched"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-extrabold text-foreground", children: articles.length }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-0.5 flex items-center justify-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border rounded-xl p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-extrabold text-cric-red", children: publishedCount }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-0.5 flex items-center justify-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isFetchingMatches ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }),
                  "Fetching..."
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                disabled: anyAutomationRunning || articles.filter((a) => a.status === "draft").length === 0,
                variant: "outline",
                className: "flex-1 sm:flex-none",
                "data-ocid": "admin.secondary_button",
          ...
          fetchedMatches.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-xl overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  ...
                  matchListOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-4 h-4 text-muted-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4 text-muted-foreground" })
                ]
              }
            ),
            matchListOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background max-h-48 overflow-y-auto", children: fetchedMatches.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0 ml-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        variant: "secondary",
                        className: `text-xs border-0 ${m.status === "live" ? "bg-red-500/15 text-red-500" : m.status === "upcoming" ? "bg-green-500/15 text-green-600" : "bg-muted text-muted-foreground"}`,
                        children: m.status.toUpperCase()
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: m.seriesCategory })
                  ] })
                ]
              },
              m.id
          ...
          automationLog.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 bg-muted/40 rounded-xl p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground mb-2", children: "Automation Log" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5 max-h-24 overflow-y-auto", children: automationLog.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-cric-red" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Auto Scheduler" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: "Automatically runs daily at 07:00 AM: fetch matches → generate articles → publish → send to Telegram." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Label,
            {
              ...
              children: schedulerEnabled ? "Scheduler ON" : "Scheduler OFF"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: isRunningAutomation ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      lastRunTime && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 rounded-xl p-4 space-y-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Articles Created" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: lastRunArticlesCount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: lastRunStatus === "success" ? "✅ Success" : "❌ Failed"
            }
          )
        ] })
      ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-5 h-5 text-cric-red" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Telegram Settings" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: "Connect your Telegram channel. Articles will be auto-posted when published." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "tg-chatid", children: "Chat ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "tg-chatid",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "For public channels, use @username. For private, use the numeric ID (prefix with -100 for supergroups)." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "tg-link", children: "Channel Link" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "tg-link",
              ...
              onChange: (e) => setTgSettings((s) => ({ ...s, channelLink: e.target.value }))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-1", children: [
          ...
          tgSettings.channelLink && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground mb-4", children: editingId ? "Edit Article" : "Add New Article" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-title", children: "Title *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "article-title",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-category", children: "Category *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: formCategory, onValueChange: setFormCategory, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "article-category", "data-ocid": "admin.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select category" }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-excerpt", children: "Excerpt" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-3 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Switch,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Label,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3.5 h-3.5 text-yellow-500" }),
                        "Mark as Featured"
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground pl-12", children: "Featured articles appear at the top of the homepage" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Label,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    role: "presentation",
                    children: [
                      formTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          placeholder: formTags.length === 0 ? "Type tag and press Enter or comma..." : "",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Press Enter or comma to add a tag (e.g. IPL, PSL, Virat Kohli)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-image", children: "Featured Image URL (optional)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "article-image",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-content", children: "Content *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                    id: "article-content",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Use ## for H2 headings, ### for H3 subheadings" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-slug", children: "SEO Slug (auto-generated)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "article-slug",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "article-published", className: "cursor-pointer", children: formPublished ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 dark:text-green-400 font-semibold", children: "Publish" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Save as Draft" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: previewOpen, onOpenChange: setPreviewOpen, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "admin.dialog", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Article Preview" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ArticlePreview,
                      {
                        title: formTitle,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-bold text-foreground flex items-center gap-2", children: [
            ...
            articles.length,
            ")",
            loadingArticles ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin text-muted-foreground" }) : !articlesError && articles.length >= 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-500 inline-block" }) : null
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: loadingArticles ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : "Refresh"
            }
          )
        ] }),
        loadingArticles ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin.loading_state", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "h-16 bg-muted rounded-xl animate-pulse"
          },
          n
        )) }) : articlesError ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", "data-ocid": "admin.error_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 text-destructive mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Failed to load articles" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: articlesErrorObj instanceof Error ? articlesErrorObj.message : "Connection error. Please try again." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "sm",
        ...
        ] }) : articles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", "data-ocid": "admin.empty_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No articles yet." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Use the form to add your first article." })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: articles.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground line-clamp-1", children: a.title }),
                  a.featured && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-0.5 text-xs font-bold text-yellow-600 dark:text-yellow-400", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3 fill-current" }),
                    "FEATURED"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatDate(a.createdAt) }),
                  a.category && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-cric-red/10 text-cric-red font-semibold px-1.5 py-0.5 rounded", children: a.category }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-xs font-semibold px-1.5 py-0.5 rounded ${a.status === "draft" ? "bg-yellow-400/20 text-yellow-600 dark:text-yellow-400" : "bg-green-500/15 text-green-600 dark:text-green-400"}`,
                      children: a.status === "draft" ? "DRAFT" : "LIVE"
                    }
                  )
                ] }),
                a.tags && a.tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mt-1", children: a.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin.dialog", children: [
