...
function ArticleCard({
  ...
  const previewText = ((_b = article.excerpt) == null ? void 0 : _b.trim()) ? article.excerpt : article.content.slice(0, 120) + (article.content.length > 120 ? "..." : "");
    ...
    Link,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl overflow-hidden shadow-card hover:border-cric-border transition-colors", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 line-clamp-2", children: previewText }),
