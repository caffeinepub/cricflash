import { a as useMatches, r as reactExports, j as jsxRuntimeExports, B as Button, C as ChevronDown } from "./index-CWQEZRIt.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BM-qWI6h.js";
import { M as MatchCard } from "./MatchCard-CTOCj8kG.js";
import { M as MatchCardSkeleton } from "./SkeletonCard-5g7j0y81.js";
import { R as RefreshCw } from "./refresh-cw-Cm0M_GZ8.js";
import { C as CircleAlert } from "./circle-alert-D7rz1Itk.js";
import "./index-Boaea9mt.js";
import "./calendar-BHcC0Rta.js";
import "./map-pin-CfzAjz4_.js";
import "./skeleton-Z6PPcnT2.js";
...
function LiveScorePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 py-4", children: [
    ...
    !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4 p-3 rounded-xl bg-muted/60 border border-border text-xs font-mono", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-muted-foreground", children: "Debug:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-background border border-border rounded px-2 py-0.5", children: [
        "Raw:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: (debugInfo == null ? void 0 : debugInfo.rawCount) ?? "—" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-background border border-border rounded px-2 py-0.5", children: [
        "Normalized:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: (debugInfo == null ? void 0 : debugInfo.normalizedCount) ?? "—" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          className: `border rounded px-2 py-0.5 ${((debugInfo == null ? void 0 : debugInfo.filteredCount) ?? 0) === 0 ? "bg-destructive/10 border-destructive/40 text-destructive" : "bg-background border-border"}`,
          children: [
            "Filtered:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: (debugInfo == null ? void 0 : debugInfo.filteredCount) ?? "—" })
          ]
        }
      )
    ] }),
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "live", children: filteredLive.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filteredLive.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) }) : seriesFilter !== "All" || typeFilter !== "All" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "live.empty_state", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "live.empty_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: "No live matches" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "upcoming", children: filteredUpcoming.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filteredUpcoming.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "live.empty_state", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: seriesFilter !== "All" || typeFilter !== "All" ? "Try adjusting your filters" : "No scheduled matches in the next 7 days" })
      ] }) }),
