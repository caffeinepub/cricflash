...
function IPLPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 py-8", children: [
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: iplArticles.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `ipl.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArticleCard, { article: a, variant: "grid", category: "IPL" }) }, a.id)) })
  ] });
}
export {
  IPLPage as default
