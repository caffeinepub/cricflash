import { a as useMatches, r as reactExports, j as jsxRuntimeExports, B as Button, C as ChevronDown } from "./index-DSMNH8Gm.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-Wo21eM6C.js";
import { M as MatchCard } from "./MatchCard-DxBdu-nq.js";
import { M as MatchCardSkeleton } from "./SkeletonCard-DVvb7s_u.js";
import { R as RefreshCw } from "./refresh-cw-BX52ymj0.js";
import { C as CircleAlert } from "./circle-alert-D23UDnz3.js";
import "./index-B_18ilWb.js";
import "./calendar-BH_Gzxl4.js";
import "./map-pin-0hTF7AYN.js";
import "./clock-wtWzNFnw.js";
...
function applyFilters(matches, seriesFilter, typeFilter) {
  return matches.filter((m) => {
    const seriesOk = seriesFilter === "All" || m.seriesCategory === seriesFilter;
...
function LiveScorePage() {
  ...
  const in2Days = new Date(now.getTime() + 2 * 24 * 60 * 60 * 1e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 py-4", children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: [1, 2, 3, 4, 5, 6].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCardSkeleton, {}, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "live", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "live", children: filteredLive.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filteredLive.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) }) : seriesFilter !== "All" || typeFilter !== "All" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", children: [
      ...
      ] }) : filteredUpcoming.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filteredUpcoming.slice(0, 2).map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "upcoming", children: filteredUpcoming.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        nearUpcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3", children: "Today & Tomorrow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: nearUpcoming.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) })
        ] }),
        futureUpcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          nearUpcoming.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3", children: "Upcoming" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: futureUpcoming.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `live.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchCard, { match: m }) }, m.id)) })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", children: [
